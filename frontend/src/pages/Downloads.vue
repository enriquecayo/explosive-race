...
<style scoped>
  .downloads-page {
    background:
      radial-gradient(circle at 10% 10%, rgba(143, 184, 216, 0.18), transparent 24%),
      radial-gradient(circle at 90% 0%, rgba(241, 179, 107, 0.16), transparent 18%),
      linear-gradient(180deg, #09111e 0%, #101a2b 100%);
    min-height: 100%;
  }
